...
def main(args, cur_date):
  ...
  """
    ...
    visualization(ori_data, generated_data, 'pca', args.data_name, cur_date)
    visualization(ori_data, generated_data, 'tsne', args.data_name, cur_date)
    ...
    for _ in range(args.metric_iteration):
        temp_disc = discriminative_score_metrics(ori_data, generated_data, parameters['data_name'], cur_date)
    ...
    for tt in range(args.metric_iteration):
        predictive_score_metrics(ori_data, generated_data, parameters['data_name'], cur_date)
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '--metric_iteration',
        help='weight of the loss of discriminator for the embedding generated by generator',
        default=1,
        type=int)
